        ...
        <x-landing.container>
            <div class="bg-white pt-32 flex flex-col lg:py-36 lg:grid lg:grid-cols-12 lg:gap-3" id="informasi">
                ...
                <div class="flex flex-col mt-20 lg:col-span-3 space-y-8">
                    ...
                    <x-landing.timelineTile number=3 date="24 November 2023" event="Penyisihan Provinsi (Online)" :isActive='true' />
                    <x-landing.timelineTile number=4 date="29 November 2023" event="Pengumuman Provinsi" :isActive='true' />
