    ...
    <div class="flex flex-col justify-between p-6 bg-white rounded-lg shadow-sm shadow-custom-grey mt-4">
        <div class="flex flex-row space-x-10">
            <div class="w-1/2 flex flex-col space-y-5">
                ...
                <x-admin.dataDiriTile type="text" label="Asal Provinsi" value="{{ $result->user->province->name ?? '-' }}" />
            ...
            <div class="w-1/2 flex flex-col space-y-5">
                ...
                <x-admin.dataDiriTile type="text" label="Nomor Handphone" value="{{ $result->user->phone_number }}" />
